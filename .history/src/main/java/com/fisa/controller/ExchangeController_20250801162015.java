...
public class ExchangeController {
    ...
    @PostMapping
    public ResponseEntity<String> postExchange(@RequestBody ExchangeRequestDTO request) throws JsonProcessingException {
        return exchangeService.requestExchange(request);
    }

    @PostMapping("/check/wonhwa")
    public ResponseEntity<String> postCheckWonhwa(@RequestBody req) throws JsonProcessingException {
        return 
    }
