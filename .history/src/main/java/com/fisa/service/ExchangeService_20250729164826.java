    ...
    public ResponseEntity<String> requestExchange(ExchangeRequestDTO requestDTO) {
        try {
            ...
            if(direction.equals("BUY")) {
                ...
                compName = jsonNode.get("base").asText().equals("KRW") ? wonhwaServerName : oehwaServerName;
            } else {
                ...
                compName = jsonNode.get("quote").asText().equals("KRW") ? wonhwaServerName : oehwaServerName;
            }
            ...
            if (postJson(withdrawalUrl, withdrawalJson).getStatusCode() == HttpStatus.OK) {
                ...
                if(postJson(depositUrl, depositJson).getStatusCode() == HttpStatus.OK) {
                    ...
                    producer.sendCompTx(compName + "Withdrawal", compTransJson);
