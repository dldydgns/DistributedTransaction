...
public class ExchangeService {
    ...
    public ResponseEntity<String> requestExchange(ExchangeRequestDTO requestDTO) {
        ...
        try {
            ...
            // todo: 출금결과 재확인 결과에 따라 보상트랜잭션 발행
            ResponseEntity<String> withdrawalResponse = checkStatusByGuid(withdrawalUrl + "/check/withdrawal", requestDTO.getGuid());
    ...
    public ResponseEntity<String> checkStatusByGuid(String url, UUID guid) {
