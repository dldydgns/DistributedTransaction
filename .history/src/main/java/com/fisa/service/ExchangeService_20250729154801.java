    ...
    public ResponseEntity<String> requestExchange(ExchangeRequestDTO request) {
        ...
        try {
            ...
            if(direction.equals("BUY")) {
                String withdrawalUrl = (jsonNode.get("base").asText().equals("KRW") ? wonhwa : oehwa);
                String depositUrl = (jsonNode.get("quote").asText().equals("KRW") ? wonhwa : oehwa);
            } else {
                String depositUrl = (jsonNode.get("base").asText().equals("KRW") ? wonhwa : oehwa);
                String withdrawalUrl = (jsonNode.get("quote").asText().equals("KRW") ? wonhwa : oehwa);
            }
