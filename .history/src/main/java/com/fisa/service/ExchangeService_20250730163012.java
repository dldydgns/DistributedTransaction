...
public class ExchangeService {
    ...
    public ResponseEntity<String> requestExchange(ExchangeRequestDTO requestDTO) {
        ...
        try {
            ...
            checkStatusByGuid(withdrawalUrl + "/check/withdrawal", requestDTO.getGuid().toString());
    ...
    public ResponseEntity<String> checkStatusByGuid(String url, String jsonBody) {
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<String> request = new HttpEntity<>(jsonBody, headers);
        return restTemplate.postForEntity(url, request, String.class);
    }
    public checkStatusByGuid
