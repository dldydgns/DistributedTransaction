...
public class ExchangeService {
    ...
    public ExchangeService(ExchangeKafkaProducer producer, ModelMapper modelMapper, ObjectMapper objectMapper, ExchangeRequestRepository exchangeRequestRepository) {
