...
public class ExchangeService {
    ...
    public ExchangeService(ModelMapper modelMapper, ObjectMapper objectMapper, ExchangeKafkaProducer producer, ExchangeRequestRepository exchangeRequestRepository) {
