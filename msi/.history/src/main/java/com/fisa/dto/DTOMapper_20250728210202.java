...
public class DTOMapper {
    ...
    public static DepositDTO toDepositDTO(ExchangeRequestDTO exchangeRequestDTO, String direction) {
        ...
        depositDTO.setAmount(direction.equals("BUY") ? exchangeRequestDTO.getBase_amount() : exchangeRequestDTO.getQuote_amount());
        depositDTO.setAccountid(direction.equals("BUY") ? exchangeRequestDTO.getBase_account() : exchangeRequestDTO.getQuote_account());
